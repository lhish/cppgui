...
int main() {
  ...
  controller.StartLoop([&]() {
    ...
    for (int i = 0; i < 20; i += 2) {
      ...
      controller.DrawRRectShadow(real->x_, real->y_, real->w_, real->h_, color_, radius_ratio_, i);
      controller.DrawRRect(real->x_, real->y_, real->w_, real->h_, color_, radius_ratio_);
      controller.DrawRRectShadow(real->x_, real->y_ + 0.1, real->w_ * 2, real->h_ * 2, color_, radius_ratio_, i);
    ...
    for (int i = 0; i < 10; i++) {
      controller.DrawRRectShadow(0.1 * (i + 1), 0.3, 0.07, 0.07, {255, 255, 255, 255}, 0,
